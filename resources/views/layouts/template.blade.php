  ...
  <div class="app-wrapper">
    ...
    <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
      ...
      <div class="sidebar-brand">
        <!--begin::Brand Link-->
        <a href="https://abdallah-alqiran.github.io/web-portfolio/" class="brand-link">
          <!--begin::Brand Image-->
          <img
            src="{{asset('assets/img/logo.png')}}"
            alt="Abdallah Alqiran Logo"
            class="brand-image opacity-75 shadow" />
          <!--end::Brand Image-->
          <!--begin::Brand Text-->
          <span class="brand-text fw-light">Abdallah Alqiran</span>
          <!--end::Brand Text-->
        </a>
        <!--end::Brand Link-->
      </div>
    ...
    <footer class="app-footer">
      ...
      <!--begin::Copyright-->
      <strong>
        <a href="https://www.linkedin.com/in/abdallah-alqiran/" class="text-decoration-none">Abdallah Alqiran</a>.
      </strong>
      All rights didn't reserved.
      <!--end::Copyright-->
    </footer>
    <!--end::Footer-->
  </div>
